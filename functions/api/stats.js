// functions/api/stats.js - Cloudflare Pages Functions route file
import { handleStatsApi } from '../handlers/api/statsApi';
import { authenticateAdmin } from '../services/authService';

export async function onRequestGet(context) {
    // Authenticate before allowing access to stats
    ...
    return await handleStatsApi(context);
}
